...
@DockerHttpClientType(value = OSGiApacheDockerHttpClientService.APACHE_HTTPCLIENT_5, transports = {
        DockerHttpClientType.TRANSPORT_STDIN_ATTACHMENT, DockerHttpClientType.TRANSPORT_WINDOWS_NPIPE,
        DockerHttpClientType.TRANSPORT_UNIX_SOCKETS })
...
public class OSGiApacheDockerHttpClientService extends ApacheDockerHttpClientImpl {
    ...
    @Activate
    public OSGiApacheDockerHttpClientService(Config config) {
